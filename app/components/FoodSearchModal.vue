  ...
  >
    <template #content>
      <div class="overflow-hidden rounded-2xl flex flex-col max-h-[85vh]">
        ...
        >
          <span v-if="!selectedFoodDetails" class="shimmer-text"
            >Search Food</span
          >
          <span v-else class="flex items-center gap-2 justify-center">
            ...
            <span class="shimmer-text text-sm truncate">{{
        ...
        <div class="flex-1 overflow-y-auto">
          ...
          <div v-else class="p-4">
            ...
            <template v-else>
              <div
                class="text-xs text-white/40 mb-3 uppercase tracking-wider font-semibold"
              >
                Serving Size
              </div>
        ...
        <div
          v-if="selectedFoodDetails && !isFetchingDetails"
